// A generated module for ModuleAbc functions
//
...
import (
	"context"
	"dagger/module-abc/internal/dagger"
)

type ModuleAbc struct {
	KubectlCLIVersion string
}

// Returns a container that echoes whatever string argument is provided
func (m *ModuleAbc) ContainerEcho(stringArg string, skipTParse string) *dagger.Container {
